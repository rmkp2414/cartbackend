			...
			<div class="container">
				<div class="row products_bar_row">
					<div class="col">
						...
						<a class="product_buttons" href="products"><Button class="product_buttons">Manage Products</Button></a>
												<c:choose>
												  <c:when test="${userType == 'Admin'}">
												   <a class="product_buttons" href="categories"><Button class="product_buttons">Manage Categories</Button></a>
												  </c:when>
												  <c:otherwise>
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name">${myProduct.name}</div>
