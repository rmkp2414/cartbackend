...
<div class="super_container">
  ...
  <div class="col-md-6 col-md-offset-3 ">
   <div class="panel panel-primary">
    <div class="panel-heading heading-text">Add Product</div>
    <div class="panel-body">
     
     
    <form action="addProductSubmit" th:action="@{/addProductSubmit}" th:object="${loginDto}" method="post">
		<br>
		<div>
		<!-- Name -->
		...
		<div>
		<!-- Description -->
		<input type="text" id="description" name="description" placeholder="Description" required="required" class="form-control" >
		</div>
		<br>
		...
		<!-- price -->
		<div>
		<input type="number" id="price" name="price" placeholder="Price" required="required" class="form-control" >
		</div>
		<br>
		
		<!-- price -->
		<div>
		<input type="number" id="rating" name="rating" placeholder="Rating" required="required" class="form-control" >
		</div>
		<br>
