		...
		<div class="products">
			<div class="container">
				...
				<div class="container" style="margin-top: 10em;">
				 <div>
				  <a type="button" class="btn btn-primary btn-md" href="addCategory">Add Category</a>
				 </div>
				 <br>
				 <div class="panel panel-primary">
				  <div class="panel-heading">
				   <h3>Manu's Clothing Categories</h3>
				  </div>
				     ...
				     <c:forEach items="${categories}" var="category">
				      <tr>
				       ...
				       <td><a type="button" class="btn btn-success"
				        href="updateCategory/${category.id}">Update</a>
				       <a type="button" class="btn btn-warning"
				        href="deleteCategory/${category.id}">Delete</a></td>
				      </tr>
				     </c:forEach>
				    </tbody>
				   </table>
