...
<div class="menu">
	...
	<div class="menu_search">
		<form action="/shoppingapp/home" id="menu_search_form" class="menu_search_form">
		...
		<div class="home">
			<div class="home_container d-flex flex-column align-items-center justify-content-end">
				<div class="home_content text-center">
					<div class="home_title">Manu's Clothing Store</div>
					<div class="breadcrumbs d-flex flex-column align-items-center justify-content-center">
						<ul class="d-flex flex-row align-items-start justify-content-start text-center">
							<li>Client Area</li>
						</ul>
						<ul class="d-flex flex-row align-items-start justify-content-start text-center">
							<li style="color : #2fce98; font-size:1.2em;">${emptyCart}</li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="products_bar d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-start justify-content-center">
							<div class="products_bar_links">
								<ul class="d-flex flex-row align-items-start justify-content-start">
									<li style="color : black; font-weight: bold;">Clothing Categories : </li>
									<li class="item_filter_btn" data-filter="*"><a href="#">All</a></li>
									<c:forEach items="${categories}" var="cat">
											<li class="item_filter_btn" data-filter=".${cat.categoryType}"><a href="#">${cat.categoryType}</a></li>
										</c:forEach>
								</ul>
							</div>
							<div class="products_bar_side d-flex flex-row align-items-center justify-content-start ml-lg-auto">
								...
								<div class="products_dropdown text-right product_dropdown_filter">
									...
									<ul>
										...
										<c:forEach items="${categories}" var="cat">
											<li class="item_filter_btn" data-filter=".${cat.categoryType}">${cat.categoryType}</li>
										</c:forEach>
									</ul>
								</div>
							</div>
				...
				<div class="row products_row products_container grid">
					...
					<c:forEach items="${products}" var="myProduct">
					   <%--  <tr>      
					    ...
					    <div class="col-xl-4 col-md-6 grid-item ${myProduct.category }">
						<div class="product">
						
							<!-- <div class="product_image"><img src="images/product_1.jpg" alt=""></div> -->
							<c:choose>
								<c:when test="${not empty myProduct.images}">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_${myProduct.rating} home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">LKR ${myProduct.priceWithoutFraction}<span>.${myProduct.priceFraction}</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
										<div onclick="window.location.href='shop/product/${myProduct.id}'"
										class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
											<div><div><img src="images/search.png" alt=""><!-- <div>+</div> --></div></div>
										</div>
										<div onclick="window.location.href='cart/${userId}/${myProduct.id}'"
										<%-- <div onclick="document.getElementById('form_${myProduct.id}').submit();"  --%>
										class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
											<%-- <form action="addCategorySubmit" th:action="@{/addCategorySubmit}" id="form_${myProduct.id}" th:object="${categoryDto}" method="post">
												<input type="hidden" value="${myProduct.id}">
											</form> --%>
