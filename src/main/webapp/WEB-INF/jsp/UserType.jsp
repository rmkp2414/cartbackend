...
<body>
<springtag:form method="post" modelAttribute="userTypeObj">
    <div class="form-group">
        <br>
        <div class="row">
            &nbsp;&nbsp;&nbsp;&nbsp;<div class="col-2"><label for="userType">User Type</label></div>
            <div class="col-3"><springtag:input path="userType" type="text" class="form-control" id="userType" aria-describedby="userType" placeholder="Enter User Type"/></div>
        </div>
        ...
        <table class="table table-hover" >
            ...
            <c:forEach items="${userTypeList}" var="userType">
                <tr>
                    ...
                    <td><a href="<c:url value='/edit-susertype-${userType.id}'/>" class="btn btn-warning">edit</a></td>
                    <td><a href="<c:url value='/delete-usertype-${userType.id}'/>" class="btn btn-danger">delete</a></td>
                </tr></c:forEach>
