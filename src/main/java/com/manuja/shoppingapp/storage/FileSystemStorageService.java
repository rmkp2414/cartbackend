package com.manuja.shoppingapp.storage;
...
public class FileSystemStorageService implements StorageService {
	...
	public String saveFile(MultipartFile file) {
		...
		String saveFileName = generatedString+file.getOriginalFilename();
		String fileDirection = "C:\\wamp\\www\\shoplingAppImages\\";
		...
		try {
			...
			return "fille upload not success. Error massage : "+e.getMessage();
		}
	}
